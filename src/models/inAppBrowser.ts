...
const IN_APP_PATTERNS: ReadonlyArray<{ id: string; pattern: RegExp }> = [
...
export type InAppDetection = {
  isInApp: boolean;
  /** Friendly app name when matched (e.g. "Facebook"), undefined otherwise. */
  appName?: string;
  /** True if window.print is missing entirely — even more dire than in-app. */
