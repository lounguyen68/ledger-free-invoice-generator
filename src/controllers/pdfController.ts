...
import type { ModalView } from "../views/modal/modalView.js";
...
export class PdfController {
  ...
  mount(): void {
    ...
    this.button = document.getElementById("download-btn") as HTMLButtonElement | null;
   ...
   */
  private async showInAppWarning(appName?: string): Promise<boolean> {
